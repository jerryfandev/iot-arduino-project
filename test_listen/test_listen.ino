...
// ── Command Phrases ────────────────────────────────────────────
// The updated library (esp32-hal-sr.h) removed the phoneme field —
// phonemes are now auto-generated internally via flite_g2p.
// sr_cmd_t only has: { command_id, str }
...
void onSrEvent(sr_event_t event, int command_id, int phrase_id) {
  ...
  case SR_EVENT_TIMEOUT:
    Serial.println("  No command heard -- timeout.");
